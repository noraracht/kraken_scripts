require(ggplot2); require(scales); require(reshape2); require(scales)

getwd()
setwd(dirname(rstudioapi::getActiveDocumentContext()$path))
getwd()

#d=read.csv("/Users/admin/Documents/Skimming/tree_of_life/summary_report_kraken_viral_dist_unmasked_0.0_corrected_k35.csv")
#d=read.csv("/Users/admin/Downloads/summary_report_kraken_viral_dist_unmasked_0.0_corrected_k35.csv")
...
qplot(value,C_sequences_prct/100,color=prct_species/100,data=m[m$variable=="mash_10K_distance" & m$value<.3,])+
  ...
  scale_color_continuous(name="Species\n classification",labels=scales::percent_format(accuracy = 1))
